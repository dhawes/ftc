...
/* $Id: BO-Front.c 98 2011-12-17 17:41:43Z 4105 $ */
...
task main()
{
  ...
  {
    turnRightTimed(MOTOR_FULL, RIGHT_OUTSIDE_TURN_TIME);
    wait1Msec(200);
  }
  ...
  if(useGyro)
  {
    moveGyro(MOTOR_FULL, MOVE_OUTSIDE_TO_BBALL_TIME);
  }
  else
  {
  ...
  {
    turnRightTimed(MOTOR_FULL, SLIGHT_OUTSIDE_RIGHT_TIME);
    wait1Msec(200);
  }
